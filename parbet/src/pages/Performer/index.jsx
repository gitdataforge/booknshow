    ...
    const { baseEvents, filteredEvents, uniqueOpponents } = useMemo(() => {
        ...
        const filtered = base.filter(m => {
            ...
            if (performerFilters.homeAway !== 'All games') {
                // Assuming t1 is usually the home team in the API response
    ...
    return (
        ...
        >
            <div className="max-w-[1200px] mx-auto px-4 md:px-8">
                {/* HERO SECTION (image_f4f702.jpg) */}
                <div className="flex flex-col md:flex-row justify-between items-start mt-6 md:mt-12 mb-8 gap-8">
                    <div className="flex-1 max-w-2xl w-full">
                        <div className="flex items-center justify-between md:justify-start gap-4 mb-8">
                            ...
                            <button onClick={() => handleRestrictedAction('Favourite')} className="w-12 h-12 rounded-full border border-gray-300 flex items-center justify-center hover:bg-gray-50 transition-colors shrink-0">
                                <Heart size={20} className="text-gray-600"/>
                            </button>
                        </div>
                        
                        {/* FILTER TABS RAIL (image_f557a3.png) */}
                        <div className="flex flex-wrap items-center gap-3 overflow-x-visible pb-2 relative z-50">
                            ...
                            <div className="relative">
                                ...
                                {/* Dropdown logic implemented inline for dynamic Opponents array */}
                                <AnimatePresence>
                        ...
                        <div className="mt-8 mb-4">
                            <h3 className="text-[17px] font-bold text-brand-text">
                                {filteredEvents.length} events {userCity !== 'All Cities' ? `near ${userCity}` : 'in all locations'}
                            </h3>
                        </div>
                        ...
                        <div className="flex flex-col space-y-3 relative z-10">
                            {isLoadingMatches ? (
                                <div className="w-full py-20 flex flex-col items-center justify-center border border-gray-200 rounded-2xl">
                                ...
                                <div className="w-full py-16 bg-gray-50 rounded-2xl border border-gray-200 text-center">
                                    ...
                                    <button onClick={() => { setLocationDropdownOpen(false); /* Logic to clear loc */ }} className="mt-4 text-[#458731] font-bold hover:underline">Clear Location Filter</button>
                                </div>
                            ) : (
                    ...
                    <div className="hidden lg:block w-[400px] shrink-0 sticky top-[100px]">
                        <div className="w-full h-[260px] rounded-[16px] overflow-hidden shadow-md border border-gray-200 bg-gray-100 mb-6">
                            <img 
                        ...
                        <div className="p-5 bg-[#F8F9FA] rounded-[16px] border border-gray-200 flex items-start gap-4">
...
// Ensure Search/Check/Clock icons are available for the local scope if not imported globally
function Search({ size, className }) { return <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.3-4.3"/></svg>; }
function Check({ size, className }) { return <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20 6 9 17l-5-5"/></svg>; }
function Clock({ size, className }) { return <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>; }