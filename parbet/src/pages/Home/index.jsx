...
/**
 * FEATURE 1: Real-Time Shared Database Integration
            ...
            >
                ...
                <div className="relative">
                    <div ref={scrollRef} className="flex overflow-x-auto hide-scrollbar space-x-4 md:space-x-5 pb-4 snap-x">
                        {events.map((event) => (
                            // We pass the raw Firestore event object to the card
                            // NOTE: ViagogoEventCard will be updated in the next step to parse this payload
                            <ViagogoEventCard 
                                key={event.id} 
                                event={event} 
